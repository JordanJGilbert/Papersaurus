                ...
                try:
                    ...
                    if template_mode:
                        ...
                        card_entry = {
                            ...
                            'cardType': card_data.get('cardType', 'custom'),
                            'tone': card_data.get('tone', 'general'),
                        ...
                        card_entry = {
                            ...
                            'cardType': card_data.get('cardType', 'custom'),
                            'tone': card_data.get('tone', 'general'),
                            'toField': card_data.get('toField', ''),
                            'fromField': card_data.get('fromField', ''),
                            'message': card_data.get('message', ''),
                            'artisticStyle': card_data.get('artisticStyle', ''),
                            'frontCover': card_data.get('frontCover', ''),
        ...
        if not is_draft_mode and generated_images.get("backCover"):
            try:
                ...
                store_card_data = {
                    ...
                    'cardType': config.get('cardType', 'custom'),
                    'tone': config.get('tone', 'general'),
                    'toField': config.get('toField', ''),
                    'fromField': config.get('fromField', ''),
                    'message': config.get('message', ''),
                    'artisticStyle': config.get('artisticStyle', ''),
                    'frontCover': generated_images.get('frontCover', ''),
                    'backCover': generated_images.get('backCover', ''),
                    'leftPage': generated_images.get('leftInterior', ''),
                    'rightPage': generated_images.get('rightInterior', ''),
